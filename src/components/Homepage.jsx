    ...
    >
      ...
      <div className="maincontainer">
        <div className="leftmost">
          <h1 style={{ color: theme == "dark" ? "white" : "rgb(28, 39, 43)" }}>
            Templates
          </h1>
          <div
          ...
          <div
            className={`templates ${template === "template10" ? "active" : ""}`}
            onClick={() => settemplate("template10")}
          >
            <img src={template10} alt="" />
          </div>
          <div
            className={`templates ${template === "template11" ? "active" : ""}`}
            onClick={() => settemplate("template11")}
          >
